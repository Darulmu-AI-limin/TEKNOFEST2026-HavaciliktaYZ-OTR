...
class SIFTMatcher:
    def __init__(self, n_features=0, n_octave_layers=3, contrast_threshold=0.04, edge_threshold=10, sigma=1.6):
    ...
    def match_with_verification(self, img1, img2, min_matches=8):
        ...
        return kp1, kp2, matches, inliers, "Basarili" if inliers >= min_matches else "Dusuk kalite"
